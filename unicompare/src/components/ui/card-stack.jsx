...
export const CardStack = ({
  ...
  return (
    <div className="relative md:h-[40vh] xl:h-[50vh] w-[90vw] md:w-[80vw] lg:w-[70vw] xl:w-[40vw]  lg:m-0 m-auto h-[30vh] ">
     {cards?.slice(0,number).map((card, index) => {
        return (
          ...
          >
           {image?<Image loading="eager" alt="UniCompare" width={800} priority="true" height={580} className="h-full w-full object-cover" src={card.url} />:<> <div className="font-normal text-neutral-700 dark:text-neutral-200">
              {card.content}
            </div>
            <div className="p-4">
