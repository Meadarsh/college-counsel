...
export async function GET() {
  try {
          ...
          messages: [
            {
              role: "system",
              content: `
    You are an expert blog writer for "UniCompare", specializing in online education.
    ...
    { "title": "generated title" }
            ...
            {
              role: "user",
              content: "Generate a unique blog title for UniCompare.",
            },
          ],
        });
        ...
        messages: [
          {
            role: "system",
            content: `
      You are an expert education blogger for "UniCompare", a platform like College Vidya 
