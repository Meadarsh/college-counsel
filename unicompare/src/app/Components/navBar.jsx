      ...
      >
        <div className="flex items-center gap-1 lg:gap-1">
          ...
          <Image
            ...
            src="/logo/collegeCounsel.png"
            alt="UniCompare"
          />
          <p className=" lg:text-lg -ml-2 lg:-ml-4 font-medium text-base">
            UniCompare
          </p>{" "}
        </div>
        <div className="lg:flex gap-5 hidden  min-w-[20%] ">
          {Links.map((example, index) => (
            <Link
              ...
              key={example.href}
              className={cn(
                "flex h-7 items-center justify-center rounded-full px-4 text-center text-lg transition-colors",
