          ...
          <TableHeader>
            <TableRow>
              {data?.table[0].map((headCell, index) => (
                <TableHead
                 className="bg-secondary lg:text-lg font-semibold text-secondary-foreground"
                  key={index}
                >
                  {headCell}
                </TableHead>
    ...
    <>
     ...
     {companies?.map((data) => (
          <div key={data?.companyName} className="border rounded-md bg-white  md:scale-100 scale-90 overflow-hidden">
            ...
            />
            <div className=" text-ellipsis whitespace-nowrap bg-secondary justify-center flex w-full">
        ...
        <>
         ...
         {approvals?.map((approval) =>(<div key={approval?.approvalName} className="border rounded-md bg-white  md:scale-100 scale-90 overflow-hidden">
            <Image
              ...
              alt={approval?.approvalName || "Approval logo"}
            />
            <div className=" text-ellipsis whitespace-nowrap bg-secondary justify-center flex w-full">
