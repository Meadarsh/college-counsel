...
const Footer = () => {
  ...
  const handleMailClick = () => {
    window.location.href = 'mailto:mail@unicompare.co.in';
  };
      ...
      <div className="md:mb-[10vw] mb-10 mx-auto">
        <div className=" container p-5 md:p-[2rem] z-20  flex flex-col-reverse lg:flex-row justify-between gap-10 ">
          <div className="lg:w-[40%] pb-10">
            <Image width={130} height={100} src="/logo/collegeCounsel.png" alt="UniCompare"/>
            <p className="text-gray-600 text-sm mt-6">
              Get admission in your dream University and course through UniCompare
              and get expert counselling and guidance along with
              scholarship options.
            </p>
            ...
            <div className="flex flex-col justify-end mt-20 md:mt-14 gap-2">
              ...
              <p onClick={handleMailClick} className="flex gap-2 cursor-pointer hover:underline items-center"><span><Mail className="w-5"/></span>email@unicompare.co.in</p>
            </div>
          </div>
