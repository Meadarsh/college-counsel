  ...
  return (
    <div className='relative h-[70vh] sm:h-[80vh] md:h-[40vh] lg:h-[40vh] xl:h-[80vh] overflow-x-clip mt-16 lg:mt-24 w-screen'>
       <div className='w-full relative h-full'>
        <div className='absolute top-[10%] blur-3xl left-0 bg-primary h-[20vh] w-[40%] rounded-[50%]'></div>
        <div className='absolute top-[50%] blur-3xl left-[85%] bg-primary h-[70vh] w-[60%] rounded-[50%]'></div>
        <div className='absolute top-[130%] blur-3xl left-[-15%] bg-primary h-[70vh] w-[25%] rounded-[50%]'></div>
       </div>
