...
const testimonials = [
  {
    quote:
      "The UniCompare service proved to be more than what I expected. The tips offered were great and the advising officials were genial and never hard to reach when asked questions on the process. With the assistance of these friends, I was in a position to get admission in the university of my choice. Highly recommend it!",
    name: "Abhishek Gupta",
  },
  {
    quote:
  ...
  {
    quote: "The UniCompare service provided all round support from the initial stage to the final stage. Their advice on the different universities and courses were very helpful. They guided me in selecting a proper college and wrote a fine application which depicted my strong points.",
    name: "Nitin Singh",
  },
  {
    quote:
  ...
  {
    quote:
      "The UniCompare service not only offered me professionalism but also the confidence boost motive. It was thus encouraging to receive their support and encouraging words as they encouraged me on. Thanks to them, I managed to get to one of the best universities in the country. Thank you!",
  ...
  {
    quote:
      "The UniCompare service is utilitarian and client centred in achieving the students' objective. Their methodical analysis procedures and focused work was a huge improvement for my application. Therefore, I want to encourage everyone to consider their help if you want to get into college.",
    name: "Kamlesh",
  },
];
