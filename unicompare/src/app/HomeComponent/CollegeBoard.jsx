...
const CollegeBoard = () => {
  return (
    <div className=' flex flex-col mt-[8vh] xl:mt-[15vh] gap-4 items-center'>
      ...
      <Link className='mx-auto lg:ml-auto lg:mr-[100px] lg:-mt-6' href={'about-university'}><Button varient="destructive" className="text-xl font-normal">MORE UNIVERSITIES<Badge className="p-0 ml-2 bg-muted text-primary"><ChevronRight/></Badge> </Button></Link>
    </div>
  )
}
