export const AboutCollege = {
  Manipal_University: {
    ...
    about: `<p>Welcome to Manipal University Online, your gateway to world-class education from the comfort of your home! <br/><br/>
    As one of India's leading Universities, Manipal University has been at the top of providing quality education for over six decades. The Manipal University online courses are designed to serve the variety of needs of learners, whether you're a working professional or a student seeking a flexible learning option. <br/><br/>
    With a wide range of Manipal University course admissions available, you can choose from undergraduate, postgraduate, and diploma programs that match with your interests and career goals.<br/><br/>
    Embark on your educational journey with Online Manipal University and unlock a world of opportunities. </p>`,
    ...
    FactAboutUniversity: [
      "All courses have been authorized by the UGC to be provided online. ",
      "The college provides online undergraduate courses such as BCA, BBA, and B.Com, as well as MCA, MBA, M.Com, and MA JMC postgraduate courses.",
      "The institution has its own LMS involving self-learning activities such as online tests, mock examinations, and lectures.",
