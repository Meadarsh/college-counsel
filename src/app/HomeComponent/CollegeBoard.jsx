  ...
  return (
    <div className=' flex flex-col mt-[8vh] lg:mt-[15vh] gap-4 items-center'>
      <h1 className='lg:text-3xl font-bold'>We have tied-up with Top Universities like</h1>
       ...
       {collegeLogo.map((e,ind)=>(<Link href={e.route||'#'}>
        <div key={ind} className='flex flex-col px-2 w-40 lg:w-52 h-24 rounded-lg justify-center items-center border border-primary'>
        <Image height={50} width={80} src={e.logoimg} alt="N/A" className='w-auto h-auto mb-2' />
